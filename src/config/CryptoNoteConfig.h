...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1318;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(990000000000000);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(39600000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff000180c0bbbfc18009025d31b65e7da4e068ce10a9b14cd38e6caad4040d8e1aca551675fc35ff384dcc2101f0445c7346e1ccf12fb6ba4e321b543f17f08b6ac7f383d9d1259d5e8b814341";
...
/* The mixin to use by default with zedwallet and stance-service */
...
const char     CRYPTONOTE_NAME[]                             = "StanceCoin";
...
const int      P2P_DEFAULT_PORT                              =  10957;
const int      RPC_DEFAULT_PORT                              =  10958;
const int      SERVICE_DEFAULT_PORT                          =  10950;

const size_t   P2P_LOCAL_WHITE_PEERLIST_LIMIT                =  2000;
const size_t   P2P_LOCAL_GRAY_PEERLIST_LIMIT                 =  7000;
...
{
    {  0xa9, 0x4f, 0x3a, 0x6a, 0xc4, 0xb2, 0xa7, 0xba, 0xd5, 0xe4, 0xc1, 0xb4, 0xb4, 0xb3, 0xe3, 0xe2  }
};
