...
**If self compiled, please provide of your StateraCoin CMake output at the default verbosity**:
```
...
**Binary Reported:** <!-- does this issue affect zedwallet, staterad, statera-service, miner? -->
